...
<br>
<div class="container">
  <h3 style="font-weight: bold; text-align: center;">Tenant Sign Up</h3><br>
  <form method="POST" action="tenant-config.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="address" placeholder="Enter Nationality" name="nationality" required>
    </div>
    
    <br>
    <center><button id="submit" name="tenant_signup" class="btn btn-primary btn-block" onclick="return Validate()">Register</button></center><br>
    <div class="form-group text-right">
      <label class="">Register as a <a href="landlord-signup.php">Landlord</a>?</label><br>
    </div><br><br>
  </form>
</div>
