	...
	<div id="header-hero-container">
		<header>
			<div class="flex container">
				...
				<a id = "logo" href='lhomepage.php'>Day's Home Rentals</a>
				<nav>
					<ul id="nav-menu">
						<li ><a href="lhomepage.php" class = "active">Home</a></li>
						...
						if(isset($_SESSION["email"]) && !empty($_SESSION['email'])){
							...
							<div class = "dropdown">
								...
								<div class=" dropdown-content">
									<a href="landlord-profile.php">My Profile</a>
									<a href="add-property.php">List Properties</a>
